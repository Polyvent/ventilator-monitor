    ...
    render() {
        ...
        return(
            <div className="ventilator-info">
                <p className={"info-name" + (this.props.alarm ? " alarm-text" : "")}>{this.props.name} <span className="info-unit">{unit}</span></p>
                <p className={"info-value" + (this.props.alarm ? " alarm-text" : "")}>{value}</p>
            </div>
        )
    }
