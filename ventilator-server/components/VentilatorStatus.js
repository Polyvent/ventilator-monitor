    ...
    render() {
        ...
        return(
            <div className={"ventilator-status " + isActiveClass}>
                <svg xmlns="http://www.w3.org/2000/svg" className={"profile-img svg-"+status} width="16" height="16" viewBox="0 0 32 32">
                ...
                <div className="info">
                    <p>{name}</p>
                    <p className="status-data"><span className={"text-"+status}>{status.toUpperCase()}</span></p>
                </div>
            </div>
        );
    }
