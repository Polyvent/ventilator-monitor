    ...
    render() {
        return(
            <div className="graphContainer">
                <LineGraph activeVentilator={this.props.activeVentilator} socket={this.props.socket} callback={this.getFlowrate} label="Flowrate" window={CHART_WINDOW_SECONDS} xmin={this.state.xmin} xmax={this.state.xmax} ymin={-30000} ymax={50000}/>
                <LineGraph activeVentilator={this.props.activeVentilator} socket={this.props.socket} callback={this.getPressure} label="Pressure" window={CHART_WINDOW_SECONDS} xmin={this.state.xmin} xmax={this.state.xmax} ymin={0} ymax={7}/>
                <LineGraph activeVentilator={this.props.activeVentilator} socket={this.props.socket} callback={this.getMVe} label="MVe" window={CHART_WINDOW_SECONDS} xmin={this.state.xmin} xmax={this.state.xmax} ymin={0} ymax={3000}/>
            </div>
        );
    }
